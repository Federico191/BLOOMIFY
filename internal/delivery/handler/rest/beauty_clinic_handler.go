...
type BeautyClinicHandler struct {
	useCase usecase.BeautyClinicUCItf
}

func NewBeautyClinicHandler(useCase usecase.BeautyClinicUCItf) *BeautyClinicHandler {
	return &BeautyClinicHandler{useCase: useCase}
}

func (bc BeautyClinicHandler) Create(ctx *gin.Context) {
	var req model.BeautyClinicRequest
...
func (bc BeautyClinicHandler) GetByCity(ctx *gin.Context) {
